...
import { X, Upload, Image as ImageIcon, Star, Phone, MapPin, DollarSign, Tag, FileText, Camera, Instagram, Facebook, Music2, ChevronRight, ChevronLeft, Check } from 'lucide-react';
            ...
            {currentStep === 1 && (
              <div className="space-y-6 animate-fadeIn">
                <div className="border-b border-gray-200 pb-4">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Describe tu servicio de forma clara y atractiva</p>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={6}
                    className="text-gray-700 w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white resize-none"
            ...
            {currentStep === 2 && (
              <div className="space-y-6 animate-fadeIn">
                <div className="border-b border-gray-200 pb-4">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Añade fotos que muestren tu trabajo (mínimo 1, máximo 5)</p>
                </div>
                ...
                >
                  ...
                  <p className={`text-lg font-medium mb-2 ${isLoading || images.length >= 5 ? 'text-gray-400' : 'text-gray-700'}`}>
                    {images.length >= 5 ? 'Límite máximo de imágenes alcanzado' : 'Arrastra y suelta imágenes aquí'}
                  </p>
            ...
            {currentStep === 3 && (
              <div className="space-y-6 animate-fadeIn">
                <div className="border-b border-gray-200 pb-4">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Define el rango de precios y la categoría de tu servicio</p>
                </div>
            ...
            {currentStep === 4 && (
              <div className="space-y-8 animate-fadeIn">
                <div className="border-b border-gray-200 pb-4">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Ayuda a tus clientes a encontrarte y contactarte</p>
                </div>
